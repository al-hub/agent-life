...
assert_contains "$config_output" "Profiles: config"
assert_not_contains "$config_output" "Profiles: home"
...
assert_contains "$env_output" "Profiles: env"
assert_not_contains "$env_output" "Profiles: config"
...
assert_contains "$home_output" "Profiles: home"
