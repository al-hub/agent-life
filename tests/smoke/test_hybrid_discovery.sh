...
assert_contains "$ready_output" "Context hint:"
assert_contains "$ready_output" "- Turn the request into a copy-ready Codex task brief; avoid implementation unless explicitly asked."
...
assert_contains "$agents_contents" "Context hint:"
assert_contains "$agents_contents" "- Turn the request into a copy-ready Codex task brief; avoid implementation unless explicitly asked."
...
assert_not_contains "$override_ready" "Context hint:"
...
assert_not_contains "$override_agents" "Context hint:"
