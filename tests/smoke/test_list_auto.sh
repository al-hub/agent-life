...
assert_contains "$list_output" "[OK] Profiles discovered: develop"
assert_contains "$list_output" "     - develop"
assert_contains "$list_output" "Runtime profiles directory"
...
assert_contains "$auto_output" "[OK] Auto Profile: develop"
assert_contains "$auto_output" "Reason: only one profile is available"
assert_contains "$auto_output" "Runtime profiles"
